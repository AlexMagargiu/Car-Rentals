  ...
  return (
    <section className="flex flex-col items-center py-28 max-w-screen-xl mx-auto px-6 gap-6">
      ...
      <div className="flex flex-col items-center justify-center w-full lg:flex-row lg:justify-between">
        <div className="flex flex-col items-center text-center gap-2 lg:max-w-lg lg:text-start lg:items-start">
          ...
          <button className="flex items-center gap-2 text-white bg-secondary_text px-8 py-4 rounded-md font-bold lg:mt-6">
